...
public class DSL {
	...
	public void escreverSac(By xpath, String texto){
		getDriver().findElement(xpath).clear();
		getDriver().findElement(xpath).sendKeys(texto);
	}
...
//apenas com o id
	...
	public void clicarBotaoCss(String selector) {
		// getDriver().findElement(By.xpath(xPath)).click();
		getDriver().findElement(By.cssSelector(selector)).click();
	}
	
	/*public void clicarBotaoTag(Webdriver driver,String tag) {
		getDriver().find_element_by_tag_name(tag);
	}
	*/
